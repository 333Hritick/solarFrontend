  ...
  const testimonials = [
    {
      ...
      systemSize: "3 kW",
      savings: "₹45,000/year",
      review: "SolarPro made the entire process seamless. From getting government subsidies to installation, everything was handled professionally. My electricity bill has reduced by 85%!",
    },
    {
      name: "Priya Sharma",
      location: "Mumbai",
    ...
    },
    {
      ...
      systemSize: "4 kW",
      savings: "₹58,000/year",
      review: "Excellent service and support. They helped me get the maximum government subsidy and the payback period is just 4 years. Highly recommend SolarPro for anyone considering solar.",
    },
    {
      name: "Sunita Singh",
      location: "Bangalore",
